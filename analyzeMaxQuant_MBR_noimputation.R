...
dev.copy(pdf, file = "Heatmap_log10int_all.pdf", height = 15, width = 7)
dev.off()
...
for (i in 1:nrow(pairs)){
  ...
  diri = paste0("diffTest_",c2,"vs",c1)
  dir.create(diri)
  
  res <- limmaDE(protdat.n_quantile, formula = "~condition", conditions = pairs[i,], 
...
res_M1vsGFP = fread("diffTest_M1_0mMvsGFP_0mM/differential_expression_table.tsv")
...
dev.copy(pdf, file = "Heatmap_log10int_M1binders.pdf", height = 7, width = 7)
dev.off()
